...
const handleEditSave = async (e) => {
  e.preventDefault();
  if (!deleteTargetId || editing) return;
  ...
  try {
    ...
    const res = await fetch(`http://localhost:3000/api/areas/${deleteTargetId}`, {
    method: "PUT",
    ...
    if (!res.ok) {
      ...
      throw new Error(`Failed to update area: ${res.status} ${t}`);
    }
    ...
    alert("Failed to edit area. See console for details.");
  } finally {
    setEditing(false);
  }
};
      ...
      <Modal open={open} onClose={handleClose}>
        <Fade in={open} timeout={200}>
          <div style={modalStyle}>
            <h2 style={{ color: "#111", margin: 0, marginBottom: 16 }}>Add New Area</h2>
...
<Modal open={editOpen} onClose={handleEditClose}>
  <Fade in={editOpen} timeout={200}>
    <div style={modalStyle}>
      <h2 style={{ color: "#111", margin: 0, marginBottom: 16 }}>Edit Area</h2>
