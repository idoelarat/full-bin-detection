...
app.use("/uploads", express.static(UPLOAD_DIR)); // שים לפני הראוטים

// --- middlewares ---
app.use(cors()); // אפשר להדק origin אם צריך
app.use(express.json({ limit: "5mb" })); // אופציונלי: הגבלת גודל JSON
